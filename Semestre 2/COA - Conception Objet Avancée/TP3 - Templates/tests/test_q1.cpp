...
TEST_CASE("intersectionResultatVide","[Q1]"){
...
TEST_CASE("intersectionVecteurVide","[Q1]"){
    vector<int> v1 = {1,2,3,4,5};
    vector<int> v2 = {};
    vector<int> r;
    vector<int> oracle = {};
...
TEST_CASE("intersectionVecteursVide","[Q1]"){
    vector<int> v1 = {};
    vector<int> v2 = {};
    vector<int> r;
    vector<int> oracle = {};
...
TEST_CASE("unionVecteurVide","[Q1]"){
    vector<int> v1 = {1,2,3,4,5};
    vector<int> v2 = {};
    vector<int> r;
    vector<int> oracle = {1,2,3,4,5};
...
TEST_CASE("unionVecteursVide","[Q1]"){
    vector<int> v1 = {};
    vector<int> v2 = {};
    vector<int> r;
    vector<int> oracle = {};
